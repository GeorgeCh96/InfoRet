...
def add_syn(old,new):
	...
	with open(old,'r+') as f:
		for line in f:
			...
			qnum += 1
def main():
	add_syn('../IR-Project-1/IndriRunQuery.queries.file.301-450-titles-only.EXAMPLE','../current_run/IndriRunQuery.queries.file.301-450-titles+synonyms-top1.EXAMPLE')
main()	
